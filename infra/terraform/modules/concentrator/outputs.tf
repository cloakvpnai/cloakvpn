output "server_name" {
  ...
  description = "Hetzner server name (e.g. cloak-fi1)."
}

output "ipv4" {
  value       = hcloud_server.concentrator.ipv4_address
  description = "Public IPv4. Point <slug>.cloakvpn.ai A record at this."
}

output "ipv6" {
  value       = hcloud_server.concentrator.ipv6_address
  description = "Public IPv6. Point <slug>.cloakvpn.ai AAAA record at this."
}
...
output "location" {
  ...
  description = "Resolved datacenter code."
}
