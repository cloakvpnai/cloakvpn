...
import ai.latticevpn.android.ui.screens.LicensesScreen
import ai.latticevpn.android.ui.screens.PaywallScreen
...
fun LatticeApp(
    ...
    Crossfade(targetState = screen, animationSpec = tween(220), label = "screen") { target ->
        when (target) {
            ...
            Screen.PAYWALL -> PaywallScreen(vm = vm)
            ...
            Screen.LICENSES -> LicensesScreen(vm = vm)
        }
    }
}
